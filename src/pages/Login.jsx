...
const Login = () => {
  ...
  return (
    <div style={pageStyle}>
      {/* Left Branding Panel (Hidden on Mobile via CSS) */}
      <div className="auth-brand-panel" style={leftPanelStyle}>
        ...
        <div style={{ zIndex: 1, cursor: 'pointer' }} onClick={() => navigate('/')}>
          ...
          <h1 style={{ fontSize: '48px', fontWeight: '800', lineHeight: '1.2', marginBottom: '24px' }}>
            Find Your Perfect<br />Stay Nearby.
          </h1>
          <p style={{ fontSize: '18px', opacity: 0.9, maxWidth: '400px', lineHeight: '1.6', marginBottom: '40px' }}>
            Join thousands of users discovering verified PGs, hostels, and premium apartments with zero brokerage.
          </p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <span style={{ fontSize: '16px', fontWeight: '500' }}>100% Verified Properties</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'rgba(255,255,255,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>✓</div>
              <span style={{ fontSize: '16px', fontWeight: '500' }}>Zero Brokerage Fees</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'rgba(255,255,255,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>✓</div>
              <span style={{ fontSize: '16px', fontWeight: '500' }}>Direct Contact with Owners</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={rightPanelStyle}>
        ...
        <div style={{ width: '100%', maxWidth: '400px' }}>
          <div style={{ marginBottom: '40px' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '16px' }}>Please enter your details to sign in.</p>
          </div>
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '24px' }}>
              <span style={{ color: 'var(--primary)', fontWeight: '600', fontSize: '14px', cursor: 'pointer' }}>Forgot password?</span>
            </div>
